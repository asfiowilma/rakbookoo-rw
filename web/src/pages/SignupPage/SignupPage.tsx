...
const SignupPage = () => {
  ...
  useEffect(() => {
    console.log("🚀 ~ file: SignupPage.tsx ~ line 24 ~ useEffect ~ isAuthenticated", isAuthenticated)
    if (isAuthenticated) {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await signUp({ email, password, data: {
      username
    } })
    console.log("🚀 ~ file: SignupPage.tsx ~ line 40 ~ response ~ response", response)
